...
internal class OpenRentalServerMessage : IWsMessage
{
    public string Type => "open_rental_server";
    public async Task<object?> ProcessAsync(JsonElement root)
    {
        ...
        if (string.IsNullOrWhiteSpace(serverId)) return new { type = "rental_roles_error", message = "参数错误" };
        ...
        {
            return new { type = "rental_roles_error", message = ex.Message };
        }
    }
}
